  ...
  <div class="mainContent">
    <template>
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item >安监局列表</el-breadcrumb-item>
      </el-breadcrumb>
    </template>

    <template>
      <div class="control">
        <el-button type="primary" icon="el-icon-circle-plus" @click="jumpLink('/ew/sib/add')">添加安监局</el-button>
      </div>
    </template>
    ...
    <div class="content">
      <template>
        <el-table :data="tableData">
          ...
          <el-table-column label="安监局名称">
            <template slot-scope="scope">
              <span>{{ scope.row.name }}</span>
            </template>
          </el-table-column>

          <el-table-column label="联系人员">
            <template slot-scope="scope">
          ...
          <el-table-column label="安监局地址" align="center">
            <template slot-scope="scope">
              <span>{{ scope.row.province }}{{ scope.row.city }}{{ scope.row.region }}{{ scope.row.addr_detail }}</span>
            </template>
          </el-table-column>
        ...
            <template slot-scope="scope">
          ...
          <el-table-column label="操作" align="center">
            <template slot-scope="scope">
              ...
              <el-button size="mini" @click="apiEdit(scope.row)">检测员列表</el-button>
            </template>
          </el-table-column>
        </el-table>
